...
/**
 * Ventana principal del juego Batalla Naval (WebSocket)
...
public class GameWindow extends JFrame {
     ...
     */
    public GameWindow(String websocketUrl) throws Exception {
        this.controller = new GameController(websocketUrl);
    ...
    private JPanel createMessagePanel() {
        ...
        scrollPane.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED); // Añadido scroll
                                                                                             // horizontal cuando sea
                                                                                             // necesario
    ...
    // Nuevo: exponer el controlador para que BoardPanel pueda llamar a placeShip
    // remoto
    ...
    public void showGameResult(boolean won, String winnerName) {
        SwingUtilities.invokeLater(() -> {
            ...
            String message = won ? "🎉 ¡Felicidades!\n\n¡Has ganado la partida!"
