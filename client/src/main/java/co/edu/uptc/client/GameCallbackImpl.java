...
public class GameCallbackImpl extends UnicastRemoteObject implements GameCallback {
    ...
    public GameCallbackImpl(GameController controller) throws RemoteException {
        super(1101); // 1101 = puerto FIJO para permitir túnel inverso SSH (-R 1101:localhost:1101)
    ...
    @Override
    public void onAttackEvent(String attackerName, int targetX, int targetY, String result, boolean yourBoard)
            throws RemoteException {
        LOGGER.info("[CALLBACK] onAttackEvent " + attackerName + " -> (" + targetX + "," + targetY + ") = " + result
                + " yourBoard=" + yourBoard);
