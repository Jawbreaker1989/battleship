...
public final class GameStatus implements Serializable {
    ...
    public static GameStatus surrendered(String winner, String surrenderedPlayer) {
        String message = surrenderedPlayer + " se ha rendido. Ganador: " + winner;
        return new GameStatus(GamePhase.FINISHED, null, false, 2, winner, message);
    }
